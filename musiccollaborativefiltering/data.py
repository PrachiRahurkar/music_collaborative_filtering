"""
This module features functions and classes to manipulate data for the collaborative
filtering algorithm.
"""
...
def load_user_artists(user_artists_file: Path) -> scipy.sparse.csr_matrix:
    """
    Load the user artists file and return a user-artists matrix in 
    ...
    # Alternating Least Square implementation works with CSR matrix
    return coo.tocsr()
...
class ArtistRetriever:
    ...
    def get_artist_name_from_id(self, artist_id: int) -> str:
        """
        Returns the artist name from the artist ID.
        """
